...
-spec encode_to_string(binary() | string()) -> binary().
encode_to_string(Data) ->
    urlencode(base64:encode_to_string(Data)).

-spec urlencode(string()|binary()) ->
                       binary().
